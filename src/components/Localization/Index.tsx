...
const Index = () => {
  ...
  return (
    <section className="bg-white">
      <div className=" text-white p-0 @desktop:p-10 rounded-ss-3xl rounded-se-3xl @desktop:!pb-10">
        <Container className="">
          ...
          <div className="relative h-[580px]">
            ...
            <div className="bg-white text-[#1E2256] w-full h-20 max-w-[770px] p-5 absolute bottom-0 @desktop:bottom-6 left-1/2 -translate-x-1/2 rounded-3xl flex flex-col @desktop:flex-row justify-between items-center gap-4 font-semibold">
              <p className="text-[17px] font-semibold">R. Fradique Coutinho, 262 - Pinheiros</p>
              <Link
                ...
                className="text-center inline-block  text-white py-3 px-4 whitespace-nowrap rounded-xl w-full max-w-[250px] hover:bg-white hover:text-[#1E2256] transition-all ease-linear border border-[#1E2256]/80"
                target="_blank"
              >
                Como chegar?
              </Link>

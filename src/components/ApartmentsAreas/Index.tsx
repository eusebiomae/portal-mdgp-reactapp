...
const Index: NextPage<ProductProps> = ({product}) => {
  return (
    <>
      ...
      >
        <Container>
          <h2 className="text-[#2B2B2B] tracking-[0.5em] uppercase text-[12px] font-arame text-2xl font-normal mb-[70px]">Galeria</h2>
        </Container>
        <SwiperCarouselImages data={product.fotos.filter((foto) => foto.escopo === 'apartamentos' || foto.escopo === 'areas')} />
      </section>
    </>
  );
};

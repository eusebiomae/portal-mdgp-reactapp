...
interface CorretorParceiroProps  {
  id_produto?: string;
}

const Index: React.FC<CorretorParceiroProps> = ({id_produto}) => {
            ...
            <div className="">
              ...
              <div className="form-group mb-4">
                ...
                <textarea
                  ...
                  name="Mensagem"
                  id="message"
                  placeholder="Olá, gostaria de mais informações sobre o Corretor Parceiro."

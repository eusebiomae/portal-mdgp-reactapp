        ...
        <div className="">
          ...
          >
            ...
            <div className="mb-[2px]">
              ...
              <textarea
                className="w-full pt-3 pb-12 px-3 bg-white text-gray-dark outline-none hover:ring-2 ring-gray-dark transition-all ease-linear border-2 border-gray-dark focus:border-gray-dark"
                name="Mensagem"
                id="message"
                placeholder="Olá, gostaria de mais informações sobre o Pluri Pinheiros."

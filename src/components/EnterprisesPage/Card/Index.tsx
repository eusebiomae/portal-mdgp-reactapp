...
const Index = ({
  ...
  return (
    <Link href="#">
      <div className="py-8">
        <div className="image relative rounded-3xl  max-@tablet:rounded-tl-[0]  max-@tablet:rounded-bl-[0]  max-@tablet:rounded-br-[0] overflow-hidden w-full h-[230px] @desktop:h-[400px] mb-5">
          <Image
          ...
          {logo_url && (
            <Image
              className="absolute top-3 left-3 w-[114px] h-[47px] @desktop:w-[128px] @desktop:h-[60px] object-contain"
              src={logo_url}
              alt=""
              width={114}
              height={47}
        ...
        <div className="text">
          <div className="flex gap-2 mb-2">
            <span className="text-body-12 flex items-center justify-center h-full border border-[#1E2256] text-[#1E2256] p-1">
              {model1}
            </span>
            <span className="text-body-12 flex items-center justify-center h-full border border-[#1E2256] text-[#1E2256] p-1">
              {model2}
          ...
          <div className="mb-5">
            ...
            <p className="text-body-14 font-thin text-[#1E2256]">{address}</p>
          </div>
